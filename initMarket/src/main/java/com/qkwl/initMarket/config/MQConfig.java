//package com.qkwl.initMarket.config;
//
...
//        properties.setProperty("ProducerId", mqProperties.getPid().getEntrustState());
//        producerBean.setProperties(properties);
//        return producerBean;
//    }
//    @Bean(initMethod = "start", destroyMethod = "shutdown")
//    public OrderProducer entrustReqProducer(MQProperties mqProperties) {
//
//        Properties properties = new Properties();
//        properties.setProperty("AccessKey", mqProperties.getAccessKey());
//        properties.setProperty("SecretKey", mqProperties.getSecretKey());
//        properties.setProperty(PropertyKeyConst.NAMESRV_ADDR, mqProperties.getOnsAddr());
//        properties.setProperty("ProducerId", mqProperties.getPid().getEntrustReq());
...
//
//    @Bean
//    public MQOrderSendHelper entrustReqMQSend(OrderProducer entrustReqProducer) {
//        MQOrderSendHelper mqSendHelper = new MQOrderSendHelper();
//        mqSendHelper.setProducer(entrustReqProducer);
//        return mqSendHelper;
//    }
//
//    @Bean
