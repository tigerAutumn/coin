    ...
    public Pagination<FEntrustHistory> listEntrustHistory(Pagination<FEntrustHistory> paginParam,
    	...
    	try {
            ...
            for (EntrustHistoryDO fEntrust : fEntrustHistories) {
                ...
                fEntrust.setFfunds(MathUtils.toScaleNum(fEntrust.getFfunds(),MathUtils.DEF_CNY_SCALE));
                fEntrust.setFleftfunds(MathUtils.toScaleNum(fEntrust.getFleftfunds(),MathUtils.DEF_CNY_SCALE));
