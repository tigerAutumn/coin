...
public class MQSendHelper {
	...
	public boolean send(String topic, String tags, String key, Object object) {
		...
		try {
			...
			logger.error("mq message key {} send error:{}", key,ExceptionUtils.getFullStackTrace(e));
			return false;
		}
	}
			...
			while (true) {
				...
				producer.sendAsync(msg, new SendCallback() {
        			...
        			public void onException(OnExceptionContext context) {
						logger.error("send mq msg {} fail! and redo it. {}",msg.getMsgID(),ExceptionUtils.getFullStackTrace(context.getException()));
