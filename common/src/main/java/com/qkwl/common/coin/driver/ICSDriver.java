...
public class ICSDriver implements CoinDriver {
	...
	public ICSDriver(String accessKey, String secretKey, String walletLink,String chainLink, String pass, BigInteger assetId, Integer coinSort) {
	...
	public String sendToAddress(String address, BigDecimal account, String comment, BigDecimal fee) {
		...
		if (fee.compareTo(BigDecimal.ZERO) >0 && !setTxFee(BigDecimal.valueOf(0.001))) {
			// 设置失败也无所谓
		}
