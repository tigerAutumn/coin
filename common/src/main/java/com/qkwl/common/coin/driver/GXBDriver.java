...
public class GXBDriver implements CoinDriver {
    ...
    public GXBDriver(Integer coinSort, String accessKey, String secretKey, String walletLink,String chainLink, String ethAccount) {
    ...
    public BigInteger getBestHeight() {
        ...
        return headJson.getBigInteger("last_irreversible_block_num");
    }
    ...
    public List<TxInfo> listTransactions(int count, int from) {
        ...
        for (Object object : jsonArray) {
            ...
            for (int i = 1; i < op2.size(); ++i) {
                ...
                txInfo.setBlockNumber(op1.getBigInteger("block_num"));
