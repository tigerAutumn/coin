...
public interface CoinDriver {
	 ...
	 * @return
	 */
	FPool getNewAddress(String time);
	 ...
	 * @return
	 */
	List<TxInfo> getBlock(BigInteger blockNum);
	 ...
	 * @return
	 */
	List<TxInfo> listTransactionsByAddress(int pageSize, int page,String address);
	 ...
	 * @return
	 */
	String sendToAddress(String from ,String to, BigDecimal amount, String memo, BigDecimal fee,String password);
	 ...
	 * @return
	 */
	ReturnResult sendToAddress(String from ,String to, BigDecimal amount, String comment, BigDecimal fee,Integer propertyid,BigDecimal satoshiPerByte);
	 ...
	 * @throws BCException 
	 */
	ReturnResult sendToAddress(String to, BigDecimal amount, BigDecimal fee, String nonce,String gasPrice,String gas,String memo);
