...
public class DateUtils {
	...
	//获取当前时间00:00:00秒
	public static Date getCurrentDay0(Date baseTime) {
		Calendar calendar = Calendar.getInstance();
		calendar.setTime(new Date());
		calendar.set(Calendar.HOUR_OF_DAY, baseTime.getHours());
		calendar.set(Calendar.MINUTE, baseTime.getMinutes());
...
//		System.out.println(DateUtils.format(DateUtils.getMonthLastDay(9),"yyyy-MM-dd HH:mm:ss"));
...
//		}
		String result = getHisDate(30);
		System.out.println(result);
		
//		Calendar calendar = Calendar.getInstance();
//		calendar.add(Calendar.MONTH, -1);
//		calendar.set(Calendar.DAY_OF_MONTH, 1);
//        System.out.println(DateUtils.format(calendar.getTime(), "yyyy-MM-dd HH:mm:ss"));
		
//		System.out.println(DateUtils.format(DateUtils.getMonthFirstDay(0), "yyyy-MM-dd HH:mm:ss"));
//		System.out.println(DateUtils.format(DateUtils.getMonthLastDay(-1), "yyyy-MM-dd HH:mm:ss"));
		System.out.println(getPastdayDate(1));
		
		System.out.println( DateUtils.format(getFutureDayDate(1), "yyyy-MM-dd HH:mm:ss"));
	}
	 ...
	 * @return
	 */
	public static Date getFutureDayDate(int i) {
		return new Date(System.currentTimeMillis() + 0x5265c00L * i);
	}
	 ...
	 * @return
	 */
	public static String getHisDate(int days) {
