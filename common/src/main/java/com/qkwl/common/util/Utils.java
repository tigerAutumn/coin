...
public class Utils {
	...
	public static boolean saveFile(String dir, String fileName, InputStream inputStream) {
		...
		int tmp = 0;
		try(FileOutputStream fileOutputStream = new FileOutputStream(realFile);) {
	...
	public static String MD5(String content) {
		...
		String retString = Base64.getEncoder().encodeToString(md5.digest(content.getBytes()));
...
//		String retString = baseEncoder.encode(md5.digest(content.getBytes()));
	...
	public static long getTimesByDay(int day) {
		...
		long dayTime = (long)day * 24 * 60 * 60 * 1000;
	...
	public static void main(String[] args) {
		System.out.println(number4String(new BigDecimal("1"),4));
		
		System.out.println(randomInteger(6));
	}
	...
	public static String getCurMonthString() {
	...
	/**
	 * 乐观锁 version累加方法，默认到99999999999999999后从零开始。
	 * @param version
	 * @return
	 */
	public static BigInteger addVersion(BigInteger version) {
		BigInteger newVersion = version.add(BigInteger.ONE);
		if (newVersion.compareTo(BigInteger.valueOf(999999999999999999L))>0) {
