...
public class MathUtils {
	...
	public static String toString8(BigDecimal bigDecimal) {
        if (bigDecimal == null) {
            bigDecimal = BigDecimal.ZERO;
        }
        return bigDecimal.setScale(8, BigDecimal.ROUND_HALF_UP).toPlainString();
    }
    
    public static String toString8AndstripTrailingZeros(BigDecimal bigDecimal) {
        if (bigDecimal == null) {
            bigDecimal = BigDecimal.ZERO;
        }
        return bigDecimal.setScale(8, BigDecimal.ROUND_HALF_UP).stripTrailingZeros().toPlainString();
    }
