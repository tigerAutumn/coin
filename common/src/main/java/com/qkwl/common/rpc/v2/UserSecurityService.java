package com.qkwl.common.rpc.v2;
...
public interface UserSecurityService {
     ...
     * 1018: 原始密码错误！<br/>
     */
    Result updateUserSecurityInfo(FUser user, ValidateParamInfo validateParam, LogUserActionEnum action, ScoreTypeEnum scoreType) ;
	 ...
	 * @return
	 */
	Result validateUserSercuritySetting(FUser user, ValidateParamInfo validateParam);
