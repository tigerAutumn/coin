...
public interface IUserService {
	...
	int getRegisterStatus(FUser user);
	 ...
	 * @throws Exception
	 */
	Result updateCheckLogin(RequestUserInfo userinfo, UserLoginType type, String ip, LocaleEnum lan);
	 ...
	 * @throws Exception
	 */
	Result updateCheckActivityLogin(RequestUserInfo userinfo, UserLoginType type, String ip, LocaleEnum lan);
	 ...
	 * @throws Exception
	 */
	Result insertRegister(RequestUserInfo userinfo, UserLoginType type);
	 ...
	 * @return
	 */
	Result insertActivityRegister(RequestUserInfo userinfo, UserLoginType type);
	 ...
	 * @return
	 */
	Integer updateByPrimaryKey(FUser user);
	 ...
	 * @return
	 */
	Integer countUserList(Integer introId);
	 ...
	 * @return
	 */
	List<Invitee> selectUserByIntroId(Integer introId);
	 ...
	 * @return
	 */
	Pagination<Invitee> selectUserPageList(Pagination<Invitee> pageParam, Invitee invitee);
	 ...
	 * @return 是否保存成功
	 */
	Boolean updateUserIntroCode(FUser fuser);
	 ...
	 * @return 用户实体对象
	 */
	FUser selectUserByFid(int fid);
	
	/** 
	 * 插入用户扩展表
	 * @param userInfoExtend
	 */
	void saveUserInfoExtend(UserInfoExtend userInfoExtend);
	 ...
	 * @return
	 */
	void changeLanguage(Integer uid);
	 ...
	 * @return
	 */
	Result modifySecondaryVerification(FUser user, Integer status, String code);
	 ...
	 * @param req
	 */
	void setAntiPhishingCode(SetAntiPhishingCodeDTO setAntiPhishingCodeDTO);

	/**
	 * 修改反钓鱼码
	 * @param dto
	 */
	void modifyAntiPhishingCode(ModifyAntiPhishingCodeDTO dto);
}
