...
public interface IAdminUserCapitalService {
	 ...
	 * @param fuid 用户id
 	 * @return 用户钱包实体
	 */
	Map<Integer,UserCoinWallet> selectUserWallet(int fuid);
	 ...
	 * @throws BCException 更新异常
	 */
    boolean platformExchange(Integer recordId, Integer adminId,SystemCoinType systemCoinType) throws BCException;
	 ...
	 * @throws BCException 更新异常
	 */
    boolean virtualCapitalWithdraw(Integer recordId, Integer adminId,CoinDriver coinDriver) throws BCException;
	 ...
	 * @throws BCException 更新异常
	 */
    boolean virtualCapitalWithdraw(Integer recordId, Integer adminId,SystemCoinType systemCoinType) throws BCException;
	 ...
	 * @param amount 总量
	 * @param gasPrice 
	 * @param isUseNewNonce 是否使用自增nonce
	 * @param coinDriver 钱包工具
	 * @return 是否执行成功
	 * @throws BCException 更新异常
	 */
	boolean updateVirtualCapitalAccelerate(Integer recordId, Integer adminId, BigDecimal amount,String gasPrice,boolean isUseNewNonce,
			CoinDriver coinDriver) throws BCException;
	 ...
	 * @return 分页查询记录列表
	 */
	public Pagination<UserCoinWallet> importUserVirtualWalletListByCoin(
			Pagination<UserCoinWallet> pageParam, UserCoinWallet filterParam);
	 ...
	 * @return 总金额
	 */
	BigDecimal selectVirtualWalletTotalAmount(Integer fuid, Integer coinid, Integer type, Integer status, Date start, Date end,Boolean isFrozen);
	 ...
	 * @return 总金额
	 */
	Map<Integer,BigDecimal> selectVirtualWalletTotalAmountMap(Integer fuid, Integer type, Integer status, Date start, Date end,Date date,Boolean isFrozen);
	 ...
	 * @return
	 */
	PageInfo<AssetImbalance> selectAssetImbalancePage(AssetImbalance params,Integer page,Integer pageSize);
	 ...
	 * @return
	 */
	PageInfo<DepositFrozenImbalance> selectdepositFrozenImbalancePage(DepositFrozenImbalance params,Integer page,Integer pageSize);
