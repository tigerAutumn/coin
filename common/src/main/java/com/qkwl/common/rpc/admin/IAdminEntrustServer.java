...
public interface IAdminEntrustServer {
	 ...
	 * @return 总量统计
	 */
	Map<Integer,FEntrustHistory> selectTotalAmountByType(Integer fuid, boolean buyCoinIdOrSellCoinId, Integer type, Date start, Date end);
	 ...
	 * @return
	 */
	int selectFEntrustCount(Integer coinId);
