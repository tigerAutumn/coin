...
public interface IAdminSystemCoinTypeService {
     ...
     * 更新币种设置
     */
    boolean updateSystemCoinSetting(List<SystemCoinSetting> records) throws BCException;
     ...
     * 币币切换
     */
    String coinSwitch(Integer oldCoinId, Integer newCoinId);
     ...
     * @return
     */
    boolean unfreezeInnovateArea(Integer coinId);

    
	void generateCoinAccount(Integer coinId);
