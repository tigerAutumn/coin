...
public enum ParameterTypeEnum {
    ...
    APIKEY(17,"#apiKey#","apiKey"),
    LOGOURL(18,"#logoUrl#","logo 地址"),
    CUSSERVERURL(19,"#cusServerUrl#","客服链接"),
    ACTIVEURL(20, "#activeUrl#", "激活链接"),
    BANURL(21,"#banUrl#","禁用账户链接"),
    ANTI_PHISHING_CODE(22,"#antiPhishingCode#","反钓鱼码"),
    ;
