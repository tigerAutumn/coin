...
public class SystemCoinInfo implements Serializable{
    ...
    private String rechargeWarnWord;
	...
	public String getGlobalTurnover() {
		if(globalTurnover == null) {
			return "--";
		}
		return globalTurnover;
	}

	public void setGlobalTurnover(String globalTurnover) {
  ...
  public String getRechargeWarnWord() {
    return rechargeWarnWord;
  }

  public void setRechargeWarnWord(String rechargeWarnWord) {
    this.rechargeWarnWord = rechargeWarnWord;
  }
