...
public enum LogAdminActionEnum {
	...
	SYSTEM_COIN_WITHDRAW_ACCELERATE(64, "审核虚拟币提现加速"),
	SYSTEM_COIN_WITHDRAW_MANUAL_COMPLETION(65, "虚拟币提现手动完成"),
	...
	C2C_RECHARGE_PASS(70,"通过c2c充值"),
	C2C_RECHARGE_REFUSE(71,"驳回c2c充值"),
	C2C_WITHDRAW_PASS(72,"通过c2c提现"),
	C2C_WITHDRAW_REFUSE(73,"驳回c2c提现"),
	
	ENABLE_OTC(74,"启用otc"),
	DISABLE_OTC(75,"禁用otc");
