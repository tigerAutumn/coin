 ...
 * @author LY
 */
public class FUserBankinfoDTO implements Serializable {
	...
	private Integer paymentType;
	  ...
	  //支付方式名称Code
    private String paymentNameCode;
  ...
  public String getPaymentNameCode() {
    return paymentNameCode;
  }

  public void setPaymentNameCode(String paymentNameCode) {
    this.paymentNameCode = paymentNameCode;
  }
