...
public class UserDayIncrement {
	...
	public String toString() {
		return "UserDayIncrement [id=" + id + ", userId=" + userId + ", coinId=" + coinId + ", tradeCost=" + tradeCost
				+ ", tradeIncome=" + tradeIncome + ", tradeFee=" + tradeFee + ", freezingOfInnovationZone="
				+ freezingOfInnovationZone + ", dividendOfInnovationZone=" + dividendOfInnovationZone
				+ ", rewardOfInnovationZone=" + rewardOfInnovationZone + ", orepoolLock=" + orepoolLock
				+ ", orepoolUnlock=" + orepoolUnlock + ", orepoolIncome=" + orepoolIncome + ", statisticsTime="
				+ statisticsTime + ", createTime=" + createTime + ", tableName=" + tableName + "]";
	}
