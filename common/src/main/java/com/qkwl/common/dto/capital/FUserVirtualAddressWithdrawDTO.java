...
public class FUserVirtualAddressWithdrawDTO implements Serializable {
    ...
    //是否收取手续费,true，收，false，不收
    private Boolean isCollectFee;
	...
	public boolean getIsCollectFee() {
		if(isCollectFee == null) {
			return true;
		}
		return isCollectFee;
	}

	public void setIsCollectFee(boolean isCollectFee) {
		this.isCollectFee = isCollectFee;
	}
