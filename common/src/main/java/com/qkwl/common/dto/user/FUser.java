...
public class FUser implements Serializable {
	...
	//是否可以开启otc
	private String canOpenOtc;
	
	//是否可以开启矿池
	private String canOpenOrepool;
	...
	//是否启用otc,true启用，false不启用
	private boolean isOtcAction;
	...
	private BigInteger leveracctid;
	
	//是否启用杠杆
	private String isOpenLever;
	...
	public boolean isOtcAction() {
		return isOtcAction;
	}

	public void setOtcAction(boolean isOtcAction) {
		this.isOtcAction = isOtcAction;
	}
	
	public String getCanOpenOtc() {
		return canOpenOtc;
	}

	public void setCanOpenOtc(String canOpenOtc) {
		this.canOpenOtc = canOpenOtc;
	}

	public String getCanOpenOrepool() {
		return canOpenOrepool;
	}

	public void setCanOpenOrepool(String canOpenOrepool) {
		this.canOpenOrepool = canOpenOrepool;
	}
	
	public BigInteger getLeveracctid() {
		return leveracctid;
	}

	public void setLeveracctid(BigInteger leveracctid) {
		this.leveracctid = leveracctid;
	}

	public String getIsOpenLever() {
		return isOpenLever;
	}

	public void setIsOpenLever(String isOpenLever) {
	...
	public String toString() {
		return "FUser [fid=" + fid + ", fshowid=" + fshowid + ", fintrocode=" + fintrocode + ", floginname="
				...
				+ ", isOtcAction=" + isOtcAction + ", isOpenLever=" + isOpenLever + ", ip=" + ip + ", score=" + score
				+ ", level=" + level + ", flastip=" + flastip + "]";
	}
