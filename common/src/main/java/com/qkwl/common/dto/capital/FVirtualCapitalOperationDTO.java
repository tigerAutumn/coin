 ...
 * @author LY
 */
public class FVirtualCapitalOperationDTO implements Serializable {
	...
	// 区块数
	private BigInteger fblocknumber;
	// 创建时间
	...
	public BigInteger getFblocknumber() {
		return fblocknumber;
	}

	public void setFblocknumber(BigInteger fblocknumber) {
	...
	public Integer getAddressCoinid() {
		return addressCoinid;
	}

	public void setAddressCoinid(Integer addressCoinid) {
		this.addressCoinid = addressCoinid;
	}
