 ...
 * @author TT
 */
public class FEntrustHistory implements Serializable {
	...
	//是否为杠杆
	private Boolean  fleverorder;

	//
	private BigDecimal ffunds;
	private BigDecimal fleftfunds;
	...
	public Boolean getFleverorder() {
		return fleverorder;
	}

	public void setFleverorder(Boolean fleverorder) {
	...
	public BigDecimal getFfunds() {
		return ffunds;
	}

	public void setFfunds(BigDecimal ffunds) {
		this.ffunds = ffunds;
	}

	public BigDecimal getFleftfunds() {
		return fleftfunds;
	}

	public void setFleftfunds(BigDecimal fleftfunds) {
		this.fleftfunds = fleftfunds;
	}
	
	public String getFmatchtype_s() {
		this.fmatchtype_s = MatchTypeEnum.getValueByCode(this.getFmatchtype());
		return  fmatchtype_s;
	}

	public void setFmatchtype_s(String fmatchtype_s) {
		this.fmatchtype_s = fmatchtype_s;
	}
}