package com.qkwl.common.dto.riskmanagement;
 ...
 * @since jdk1.8
 */
public class SystemRiskManagementDto implements Serializable {
     ...
     * 1:已发放 2:已预警,3:已平仓
     */
    public SystemRiskManagementDto(Integer userStatus) {
        this.userStatus = userStatus;
    }

    public SystemRiskManagementDto() {
    }

    public SystemRiskManagementDto(SystemRiskManagementDto item, Double accountRealFunds) {
        this.userId = item.getUserId();
        this.accountRealFunds = accountRealFunds;
        this.coinId = item.getCoinId();
    }

    public SystemRiskManagementDto(Integer userId, Integer status) {
        this.userId = userId;
        this.userStatus = status;
    }
    public SystemRiskManagementDto(Integer id,Integer userId, Integer status) {
        this.id = id;
        this.userId = userId;
        this.userStatus = status;
