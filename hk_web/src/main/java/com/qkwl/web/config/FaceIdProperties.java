...
public class FaceIdProperties {
	...
	private String return_redirect_url;
	...
	public String getReturn_redirect_url() {
		return return_redirect_url;
	}
	public void setReturn_redirect_url(String return_redirect_url) {
		this.return_redirect_url = return_redirect_url;
	}
