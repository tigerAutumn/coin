...
public class FrontFinancialJsonController extends JsonBaseController {
    ...
    @ResponseBody
    @ApiOperation("")
	@RequestMapping(value="/submit_finances",method = {RequestMethod.GET,RequestMethod.POST})
    public ReturnResult submitFinances(
        ...
        if (count.compareTo(new BigDecimal(100)) < 0) {
            return ReturnResult.FAILUER(I18NUtils.getString("capital.finances.com.1000"));
        }
        ...
        if (coinType == null || !coinType.getIsFinances()
            ...
            return ReturnResult.FAILUER(I18NUtils.getString("capital.finances.com.1001"));
        }
        if (financesid == null) {
            return ReturnResult.FAILUER(I18NUtils.getString("capital.finances.com.1002"));
        }
        ...
        try {
            ...
            if (result.getSuccess()) {
                return ReturnResult.SUCCESS(I18NUtils.getString("capital.finances.create." + result.getCode().toString()));
            } else if (result.getCode().equals(Result.PARAM)) {
                logger.error("submitFinances {}", result.getMsg());
            } else if (result.getCode() < 10000) {
                return ReturnResult.FAILUER(I18NUtils.getString("capital.finances.create." + result.getCode().toString()));
            } else {
                return ReturnResult.FAILUER(I18NUtils.getString("com.error." + result.getCode().toString(), result.getData().toString()));
            }
        } catch (Exception e) {
            logger.error("submitFinances error,e:{}",e);
        }
        return ReturnResult.FAILUER(I18NUtils.getString("com.error.10117"));
    }
    ...
    @ResponseBody
    @ApiOperation("")
	@RequestMapping(value="/get_finances",method = {RequestMethod.GET,RequestMethod.POST})
    ...
    @ResponseBody
    @ApiOperation("")
	@RequestMapping(value="/cancel_finances",method = {RequestMethod.GET,RequestMethod.POST})
    public ReturnResult cancelFinances(
            ...
            if (result.getSuccess()) {
                return ReturnResult.SUCCESS(I18NUtils.getString("capital.finances.cancle." + result.getCode().toString()));
            } else if (result.getCode().equals(Result.PARAM)) {
                logger.error("cancelFinances {}", result.getMsg());
            } else if (result.getCode() < 10000) {
                return ReturnResult.FAILUER(I18NUtils.getString("capital.finances.cancle." + result.getCode().toString()));
            } else {
                return ReturnResult.FAILUER(I18NUtils.getString("com.error." + result.getCode().toString(), result.getData().toString()));
            }
        return ReturnResult.FAILUER(I18NUtils.getString("com.error.10117"));
    ...
    @ResponseBody
    @ApiOperation("")
	@RequestMapping(value="/financial/index_json",method = {RequestMethod.GET,RequestMethod.POST})
    ...
    @ResponseBody
    @ApiOperation("")
	@RequestMapping(value="/financial/accountcoin_json",method = {RequestMethod.GET,RequestMethod.POST})
    ...
    @ResponseBody
    @ApiOperation("")
	@RequestMapping(value="/financial/finances_json",method = {RequestMethod.GET,RequestMethod.POST})
