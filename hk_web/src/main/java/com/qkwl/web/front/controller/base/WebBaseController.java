...
public class WebBaseController extends RedisBaseControll {
    ...
    public void menuSelect() {
        ...
        String uri = HttpHolderUtils.getHttpServletRequest().getRequestURI();
        ...
        HttpHolderUtils.getHttpServletRequest().setAttribute("selectMenu", selectMenu);
        ...
        if (uri.startsWith("/trade") ||
            ...
            HttpHolderUtils.getHttpServletRequest().setAttribute("selectGroup", selectGroup);
            HttpHolderUtils.getHttpServletRequest().setAttribute("leftMenu", leftMenu);
        }
    }
    ...
    public void addConstant() {
        ...
        HttpHolderUtils.getHttpServletRequest().setAttribute("localeStr", localeStr);
        HttpHolderUtils.getHttpServletRequest().setAttribute("staticurl", redisHelper.getSystemArgs("staticurl"));

        //设置指定键对值的系统属性
        // 前端常量
        HttpHolderUtils.getHttpServletRequest().setAttribute("constant", redisHelper.getSystemArgsList());
//        // 首条公告
...
//        sessionContextUtils.getContextRequest().setAttribute("ffriendlinks", ffriendlinks);
        ...
        if (fuser != null) {
            ...
            HttpHolderUtils.getHttpServletRequest().setAttribute("userInfo", fuser);
        }
    }
