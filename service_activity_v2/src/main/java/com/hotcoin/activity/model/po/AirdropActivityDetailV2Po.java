...
public class AirdropActivityDetailV2Po implements Serializable {
     ...
     * 用于根据类型查询活动详情
     * activityType 1:注册空投活动,2:充值空投活动3:交易空投活动
     * typeDetail: 币币充值和法币充值 .coin,legalMoney
     */
    public AirdropActivityDetailV2Po(Integer activityType, String typeDetail, String airDropCoin, Double rule) {
        this.typeDetail = typeDetail;
        this.airDropCoin = airDropCoin;
        this.activityType = activityType;
        this.rule = rule;
     ...
     * @param activityType 活动类型: 1:注册空投活动,2:充值空投活动3:交易空投活动
     */
    public AirdropActivityDetailV2Po(int userId, Integer activityType, String typeDetail, Double rule, String coin) {
        this.userId = userId;
        this.typeDetail = typeDetail;
        this.airDropCoin = coin;
        this.activityType = activityType;
