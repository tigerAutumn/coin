...
public class MQSend {
	 ...
	 * @throws BCException
	 */
	public void SendUserAction(int fagentid, int fuid, LogUserActionEnum action, String fip) {
	 ...
	 * @throws BCException
	 */
	public void SendUserAction(int fagentid, int fuid, LogUserActionEnum action, String fip, int fdatatype, String fcontent) {
	...
	public void SendUserAction(int agentId, int uid, LogUserActionEnum action, Integer dataType, BigDecimal data, String ip, BigDecimal fees,String content , Integer capitalType ) {
