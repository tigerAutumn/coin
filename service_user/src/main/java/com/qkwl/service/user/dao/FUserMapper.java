...
public interface FUserMapper {
     ...
     * @return 实体对象
     */
    FUser selectByIntroCode(String fintrocode);
     ...
     * @return 实体对象列表
     */
    List<FUser> getUserListByFUser(FUser user);
     ...
     * @return
     */
    int CheckIsExistByParam(FUser user);
     ...
     * @return 本IP人数
     */
    int selectIpUserCount(Long flastip);
     ...
     * @return 用户列表
     */
	List<Invitee> getUserPageList(Map<String, Object> map);
     ...
     * @return 成功条数
     */
    int updateIntroCode(FUser user); 
     ...
     * @return
     */
    FUser selectByLeverAcctId(Integer leverAcctId);
}