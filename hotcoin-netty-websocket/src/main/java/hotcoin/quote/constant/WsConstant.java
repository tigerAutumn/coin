...
public interface WsConstant {
     ...
     * 币对24小时行情数据
     */
    String TRADE_24H_TICKER_STR = "market.%s.24h.tickers";
    /**
     * 精简字段数据
     */
     ...
     * 明星币
     */
    String TRADE_STAR_COIN_STR = "market.trade.star.coin";

    /**
     * 成交额榜
     */
    String TRADE_AMOUNT_RANK_STR = "market.trade.amount.rank";

    /**
     * 数字0
     */
    String TRADE_CONSTANT_ZERO = "0";

    /**
     * 拉取数据字段
     */
    String TRADE_PULL_REQ = "req";

    String TRADE_PULL_LIMIT = "limit";

    String TRADE_NULL_STR = "null";
