...
public class FUserBankinfoDO implements Serializable {
	...
	public String toString() {
		return "FUserBankinfoDO [fid=" + fid + ", fuid=" + fuid + ", fname=" + fname + ", fbanknumber=" + fbanknumber
				+ ", fbanktype=" + fbanktype + ", fbanktype_s=" + fbanktype_s + ", fcreatetime=" + fcreatetime
				+ ", fstatus=" + fstatus + ", version=" + version + ", init=" + init + ", faddress=" + faddress
				+ ", frealname=" + frealname + ", fprov=" + fprov + ", fcity=" + fcity + ", ftype=" + ftype + ", fdist="
				+ fdist + ", isDefault=" + isDefault + ", logo=" + logo + ", qrcodeImg=" + qrcodeImg + ", paymentType="
				+ paymentType + "]";
	}
