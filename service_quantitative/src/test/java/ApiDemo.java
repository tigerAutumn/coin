...
public class ApiDemo  {
     ...
     * 配置你的KEY
     */
    private final static String ACCESS_KEY = "9d45223f6b9d4ed18add87cbf4ee841f";
    private final static String SECRET_KEY = "0DDA422B4632784F66E1ED14D95186BA";
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        String Signature = getSignature(SECRET_KEY, HOST, uri, httpMethod, params);
        params.put("Signature", Signature);
        doHttpRequest("hktestapi.hotcoin.top", uri, httpMethod, params);
