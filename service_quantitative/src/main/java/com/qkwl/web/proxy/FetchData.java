...
public class FetchData implements IFetchData {
    ...
    public ReturnResult MarketJson(Integer symbol, Integer buysellcount, Integer successcount) {
        ...
        jsonObject.put("total", tickerData == null ? 0d : tickerData.getVol());
        jsonObject.put("buy", tickerData == null ? 0d : tickerData.getBuy());
        jsonObject.put("sell", tickerData == null ? 0d : tickerData.getSell());
        // 深度
    ...
    public ReturnResult IndexMarketJson(Integer locale) {
        ...
        for (SystemTradeType tradeType : tradeTypes) {
            ...
            jsonitem.put("price", tickerData == null ? 0d : tickerData.getLast());
            jsonitem.put("total", tickerData == null ? 0d : tickerData.getVol());
            jsonitem.put("rose", tickerData == null ? 0d : tickerData.getChg());
            jsonitem.put("buy", tickerData == null ? 0d : tickerData.getBuy());
            jsonitem.put("sell", tickerData == null ? 0d : tickerData.getSell());
