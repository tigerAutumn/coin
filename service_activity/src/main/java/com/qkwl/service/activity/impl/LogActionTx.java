...
import com.qkwl.service.activity.dao.FDayCapitalCoinMapper;
import com.qkwl.service.activity.dao.FDayCapitalRmbMapper;
import com.qkwl.service.activity.dao.FDayOperatMapper;
import com.qkwl.service.activity.dao.FDaySumMapper;
import com.qkwl.service.activity.dao.FDayTradeCoinMapper;
...
public class LogActionTx {
	...
	public FDayTradeCoin getFDayTradeCoin(int coinId, String time, Integer fagentid) {
		List<FDayTradeCoin> fDayTradeCoins = this.fDayTradeCoinMapper.selectByDate(coinId, time, fagentid);
		return fDayTradeCoins.size() > 0 ? fDayTradeCoins.get(0) : null;
	}
	 ...
	 * @return 每日交易
	 */
	public FDayTradeCoin insertfDayTradeCoin(int coinId, Date time, Integer fagentid) {
		FDayTradeCoin fDayTradeCoin = new FDayTradeCoin();
		...
		fDayTradeCoin.setFupdatetime(time);
		fDayTradeCoin.setFcreatetime(time);
