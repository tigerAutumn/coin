package com.hotcoin.sharding.mapper;
...
public interface FEntrustHistoryMapper {
     ...
     * @return 委单统计
     */
    List<FEntrustHistory> getTotalAmountByTypeList(Map<String, Object> map);
     ...
     * @return
     */
    FEntrustHistory selectHistoryEntrust(Map<String, Object> map);
}